...
4. Tailor all advice specifically to their active mode (${modeId}) and their somatic profile.`;
  ...
  // --- Specific Nutrition Queries ---
    ...
    responseText = `### 🥗 Precision Post-Workout Anabolic Fuel Window\n\nConsume within 45 minutes of finishing training for maximum protein synthesis:\n\n- **High BV Protein Target (30–35g)**: 150g grilled chicken tikka, 180g low-fat paneer bhurji, 3 egg whites, or 1.5 scoops whey isolate.\n- **Glycogen Replenishment (45–50g carbs)**: 2 wheat rotis + dal, 1 ripe banana + 45g rolled oats, or a small rajma-chawal portion.\n- **Electrolyte Restoration**: 500ml water with a pinch of Himalayan pink salt + squeeze of lemon.\n- **Probiotic Bonus**: A bowl of fresh dahi (curd) aids protein absorption and gut recovery.\n\n*Current Daily Target*: **${context.metabolic.targetCalories || 2150} kcal**.`;
  } else if (/breakfast|recipe|morning meal/i.test(msgLower)) {
    responseText = `### 🍳 Clean 450-Kcal High-Protein Indian Breakfast\n\nCalibrated for your **${context.metabolic.somaticType}** body composition:\n\n**Option 1 — South Indian:**\n- 3 steamed Idlis + Sambar (no oil) + coconut chutney (1 tsp)\n- 1 glass skimmed milk or chaas\n\n**Option 2 — North Indian:**\n- Moong Dal Chilla (2 pieces) with mint-coriander chutney\n- 2 boiled eggs or ½ cup paneer bhurji (no butter)\n\n**Option 3 — Power Breakfast:**\n- Oats porridge with banana + 1 tbsp peanut butter\n- 5–6 soaked almonds and a glass of warm turmeric milk\n\n*Nutritional Breakdown*: ~30g Protein | ~45g Carbs | ~12g Fats | ~440 kcal.`;
  } else if (/hydrat|water|bloat|drink/i.test(msgLower)) {
    responseText = `### 💧 Anti-Bloat Hydration Protocol\n\nYou have logged **${context.waterMl} ml** today. To hit your target without stomach distension:\n\n- **Cadence**: Sip 180–220ml every 45 minutes instead of chugging large amounts at once.\n- **Indian Alternatives**: Jeera (cumin) water, coconut water, or diluted chaas (buttermilk) are excellent natural electrolyte sources.\n- **Sodium Balance**: Add a pinch of pink Himalayan salt or lemon juice to prevent electrolyte dilution.\n- **Timing**: Cease large fluid volumes 60 minutes before heavy squat sessions and sleep.`;
  }
  ...
  // Generic Mode Fallbacks
    ...
    responseText = `### 🥗 Precision Metabolic Fuel Plan 🇮🇳\n\nTargeting your daily allocation of **${context.metabolic.targetCalories || 2150} kcal**:\n\n- **Post-Workout Protein (30–35g)**: Paneer bhurji, grilled chicken tikka, egg whites, or moong dal chilla.\n- **Complex Carbs**: 2 rotis + dal, rajma-chawal (small portion), or brown rice with sabzi to replenish muscle glycogen.\n- **Hydration Status**: Logged **${context.waterMl} ml** today — aim for an additional **${Math.max(0, 3000 - context.waterMl)} ml** via water, jeera water, or chaas.\n- **Snack Tip**: Boiled sprouts chaat or kala chana salad between meals to stay full and hit your protein target.`;
